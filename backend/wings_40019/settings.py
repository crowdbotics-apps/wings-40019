"""
Django settings for wings_40019 project.
...
WSGI_APPLICATION = 'wings_40019.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wings_40019 API",
    "DESCRIPTION": "API documentation for wings_40019 App",
    "VERSION": "v1",
}
